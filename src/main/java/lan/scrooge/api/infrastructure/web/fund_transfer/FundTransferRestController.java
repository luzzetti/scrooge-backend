...
public class FundTransferRestController implements FundTransferRestApi {
  ...
  private BankTransactionOverviewResource.TransactionType evaluateTransactionType(
    ...
    return (isIncome)
        ? BankTransactionOverviewResource.TransactionType.INCOME
        : BankTransactionOverviewResource.TransactionType.EXPENSE;
  }
}
